                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'title'">{{ trans('admin.item.columns.title') }}</th>
                                    <th is='sortable' :column="'name'">{{ trans('admin.item.columns.name') }}</th>
                                    <th is='sortable' :column="'storable_id'">{{ trans('admin.item.columns.storable_id') }}</th>
                                    <th is='sortable' :column="'storable_type'">{{ trans('admin.item.columns.storable_type') }}</th>
