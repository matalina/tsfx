                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'full_name'">{{ trans('admin.person.columns.full_name') }}</th>
                                    <th is='sortable' :column="'name'">{{ trans('admin.person.columns.name') }}</th>
                                    <th is='sortable' :column="'is_self'">{{ trans('admin.person.columns.is_self') }}</th>
                                    <th is='sortable' :column="'always_on_person'">{{ trans('admin.person.columns.always_on_person') }}</th>
                                    <th is='sortable' :column="'location'">{{ trans('admin.person.columns.location') }}</th>
